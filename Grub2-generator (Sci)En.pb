...
Lng(1) = "Always run as root?"
Lng(2) = "Always run as root? The choice will be saved."
Lng(3) = "'Cancel' launches without root and does not save selections"
Lng(4) = "Open grub.cfg"
Lng(5) = "Save to selected file"
Lng(6) = "Reopen *.cfg"
Lng(7) = "Make a backup of the config"
Lng(8) = "Item Menu (select item)"
Lng(9) = "Save item data"
Lng(10) = "Find text (Ctrl + F), continue - F3"
Lng(11) = "Find and Replace (Ctrl + H)"
Lng(12) = "Fill in the classes so that the icon is displayed"
Lng(13) = "Info about UUID"
Lng(14) = "Add an item above the current one"
Lng(15) = "Delete selected item"
Lng(16) = "Duplicate selected item"
Lng(17) = "Rename"
Lng(18) = "Save as template"
Lng(19) = "Enter a new item name"
Lng(20) = "Please select an item first"
Lng(21) = "Open file"
Lng(22) = "Config (*.cfg)|*.cfg"
Lng(23) = "Added"
Lng(24) = "Close without saving?"
Lng(25) = "Do you want to close the program without saving the file?"
Lng(26) = "Successfully"
Lng(27) = "Error"
Lng(28) = "Enter the name of the item"
Lng(29) = "Re-record?"
Lng(30) = "Do you want to overwrite the file...?"
Lng(31) = "Save"
Lng(32) = "grub.cfg|grub.cfg|Config (*.cfg)|*.cfg|All files (*.*)|*.*"
Lng(33) = "Failed to create file."
Lng(34) = "Find"
Lng(35) = "Enter search text"
Lng(36) = "Empty file: "
Lng(37) = "Replace UUID?"
Lng(38) = "You want to replace the UUID found in the template: "
Lng(39) = "to the UUID located on the clipboard: "
Lng(40) = "Find and Replace"
Lng(41) = "Replacement"
Lng(42) = "Replace everything"
Lng(43) = "Calculate"
Lng(44) = "Match case"
Lng(45) = "Search in points"
Lng(46) = "Search in classes"
Lng(47) = "Search in code"
Lng(48) = "Search fields are empty"
Lng(49) = "No places to search have been selected, where to look?"
Lng(50) = "Found: "
Lng(51) = "Done"
...
If UserIntLang
	Lng(1) = "Запускать всегда от root?"
	Lng(2) = "Запускать всегда от root? Выбор будет сохранён. "
	Lng(3) = "'Отмена' запускает без root и не сохраняет выбор"
	Lng(4) = "Открыть grub.cfg"
	Lng(5) = "Сохранить в выбранный файл"
	Lng(6) = "Переоткрыть *.cfg"
	Lng(7) = "Сделать бэкап конфига"
	Lng(8) = "Меню пунктов (выберите пункт)"
	Lng(9) = "Сохранить данные пункта"
	Lng(10) = "Найти текст (Ctrl + F), продолжить - F3"
	Lng(11) = "Найти и заменить (Ctrl + H)"
	Lng(12) = "Заполнить классы, чтобы отображалась иконка"
	Lng(13) = "Инфа о UUID"
	Lng(14) = "Добавить пункт над текущим"
	Lng(15) = "Удалить выбранный пункт"
	Lng(16) = "Дублировать выбранный пункт"
	Lng(17) = "Переименовать"
	Lng(18) = "Сохранить как шаблон"
	Lng(19) = "Введите новое имя пункта"
	Lng(20) = "Сначала выберите пункт"
	Lng(21) = "Открыть файл"
	Lng(22) = "Конфиг (*.cfg)|*.cfg"
	Lng(23) = "Добавлено"
	Lng(24) = "Закрыть без сохранения?"
	Lng(25) = "Вы хотите закрыть программу без сохранения файла?"
	Lng(26) = "Успешно"
	Lng(27) = "Ошибка"
	Lng(28) = "Укажите имя пункта"
	Lng(29) = "Перезаписать?"
	Lng(30) = "Вы хотите перезаписать файл ...?"
	Lng(31) = "Сохранить"
	Lng(32) = "grub.cfg|grub.cfg|Конфиг (*.cfg)|*.cfg|Все файлы (*.*)|*.*"
	Lng(33) = "Не удалось создать файл."
	Lng(34) = "Найти"
	Lng(35) = "Введите текст поиска"
	Lng(36) = "Пустой файл: "
	Lng(37) = "Заменить UUID?"
	Lng(38) = "Вы хотите заменить найденный в шаблоне UUID: "
	Lng(39) = "на UUID находящийся в буфере обмена: "
	Lng(40) = "Найти и заменить"
	Lng(41) = "Замена"
	Lng(42) = "Заменить всё"
	Lng(43) = "Подсчитать"
	Lng(44) = "Учитывать регистр"
	Lng(45) = "Искать в пунктах"
	Lng(46) = "Искать в классах"
	Lng(47) = "Искать в коде"
	Lng(48) = "Поля поиска пусты"
	Lng(49) = "Не выбраны места для поиска, где искать?"
	Lng(50) = "Найдено: "
	Lng(51) = "Выполнено"
EndIf
...
CompilerIf  #PB_Compiler_OS = #PB_OS_Linux
	...
	CompilerElse
		...
		If root = 1
			...
			EndIf
		ElseIf root = -1
			Select MessageRequester(Lng(1), Lng(2) + #CRLF$ + Lng(3), #PB_MessageRequester_YesNoCancel)
...
If OpenWindow(#Window_0, 0, 0, w, h, "", #PB_Window_SystemMenu | #PB_Window_SizeGadget | #PB_Window_MaximizeGadget | #PB_Window_MinimizeGadget | #PB_Window_ScreenCentered)
	...
	GadgetToolTip(#btnOpn , Lng(4))
	ButtonImageGadget(#btnSave, 50, 5, 28, 28, ImageID(3))
; 	ButtonGadget(#btnSave, 10, 5, 90, 30, Lng(31))
	GadgetToolTip(#btnSave , Lng(5))
	
	ButtonImageGadget(#btnReOpn, 90, 5, 28, 28, ImageID(7))
	GadgetToolTip(#btnReOpn , Lng(6))
	
	ButtonImageGadget(#btnBackup, 130, 5, 28, 28, ImageID(13))
	GadgetToolTip(#btnBackup , Lng(7))
...
; 	EditorGadget(#Edit, 270, 75, w - 280, h - 85)
	...
	If CreatePopupImageMenu(#Menu)
		MenuItem(#mAdd, Lng(14), ImageID(1))
		MenuItem(#mDel, Lng(15), ImageID(2))
		MenuItem(#mDupl, Lng(16), ImageID(8))
		MenuItem(#mRename, Lng(17), ImageID(10))
		MenuItem(#mSvTmp, Lng(18), ImageID(13))
	EndIf
			...
			Case #PB_Event_Menu
				...
				Select em
					...
					Case #mRename
						...
						tmp$ = InputRequester(Lng(17), Lng(19), tmp$)
						If Asc(tmp$)
							idx = GetGadgetState(#LV)
							If idx <> -1
...
;-├ Gadget events
			Case #PB_Event_Gadget
				Select EventGadget()
					...
					Case #btnOpn
						PathTmp$ = OpenFileRequester(Lng(21), PathGrubcfg$, Lng(22), 0)
...
; 						Debug tmp$
			...
			Case #PB_Event_CloseWindow
				If needsaveTotal And MessageRequester(Lng(24), Lng(25), #PB_MessageRequester_YesNo) = #PB_MessageRequester_No
					Continue
				EndIf
...
Procedure SaveBackup()
	...
	If root = 1
		...
		If ForceDirectories(DestinationPath$) And CopyFile(PathGrubcfg$, DestinationPath$ + #PS$ + File$)
			...
			CompilerEndIf
			MessageRequester(Lng(26), DestinationPath$ + #CRLF$ + #CRLF$ + File$)
		Else
			MessageRequester(Lng(27), Lng(27), #PB_MessageRequester_Error)
		EndIf
	Else
...
Procedure SaveToTemplate()
	...
	If idx <> -1
		...
		Name$ = InputRequester(Lng(28), Lng(28), Name$)
		If Not Asc(Name$)
			ProcedureReturn
		EndIf
		
		File$ = SaveFileRequester(Lng(21), PathTemplate$ + Name$, "*.cfg|*.cfg", 0)
		If Asc(File$)
		...
		Else
			ProcedureReturn
		EndIf
		If FileSize(File$) > -1 And MessageRequester(Lng(29), Lng(30), #PB_MessageRequester_YesNo) = #PB_MessageRequester_No
			ProcedureReturn
		EndIf
...
; 	Protected tmp, tmp$
	PathTmp$ = SaveFileRequester(Lng(31), PathGrubcfg$, Lng(32), 0)
	If Asc(PathTmp$)
		PathGrubcfg$ = PathTmp$
		PathTmp$ = ""
		Text$ = ""
...
; 	Protected tmp, tmp$
	...
	If Asc(tmp$) And (FindString(tmp$, #LF$) Or FindString(tmp$, #CR$))
		tmp$ = ""
	EndIf
	FindText$ = InputRequester(Lng(34), Lng(35), tmp$)
	If Asc(FindText$)
		idx = 0
		ForEach MenuEntryList()
			tmp = FindString(MenuEntryList()\Code, FindText$, 1, #PB_String_NoCase)
...
; 	условие для первого запуска
	If FileSize(PathGrubcfg$) < 0; Or Not (GetFileAttributes(PathGrubcfg$) & #PB_FileSystem_ReadAll) ; отсутствует или нет разрешения чтения
		PathGrubcfg$ = OpenFileRequester(Lng(21), PathGrubcfg$, Lng(22), 0)
...
; 			MessageRequester("", "Не найден файл: " + PathGrubcfg$)
	...
	If Not Asc(Text$)
		MessageRequester("", Lng(36) + PathGrubcfg$)
		Text$ = ""
		ProcedureReturn 0
	EndIf
...
Procedure AddItemList0()
	Protected tmp$, idx
	tmp$ = OpenFileRequester(Lng(21), PathTemplate$, Lng(22), 0)
...
Procedure AddItemList(ind)
	...
	If Len(UUIDclipboard$) = 36
		...
		If Asc(UUIDclipboard$)
			...
			EndIf
			If Asc(UUIDcode$)
				If MessageRequester(Lng(37), Lng(38) + #LF$ + UUIDcode$ + #LF$ + Lng(39) + #LF$ + UUIDclipboard$, 
...
;- 	GUI Search
	If OpenWindow(#WinFind, #PB_Ignore, #PB_Ignore, 475, 185, Lng(40), #PB_Window_MinimizeGadget | #PB_Window_MaximizeGadget | #PB_Window_SizeGadget | #PB_Window_ScreenCentered, WindowID(#Window_0))
		

		TextGadget(#txt1, 5, 8, 59, 17, Lng(34))
		TextGadget(#txt2, 5, 42, 59, 17, Lng(41))
		StringGadget(#strg1, 65, 5, 400, 27, "")
		StringGadget(#strg2, 65, 40, 400, 27, "")
		ButtonGadget(#btnReplaceAll, 345, 75, 120, 40, Lng(42))
		ButtonGadget(#btnCount, 345, 120, 120, 40, Lng(43))
		CheckBoxGadget(#chCase, 165, 75, 175, 25, Lng(44))
; 		CheckBoxGadget(#chRegExp, 5, 93, 185, 20, "Регулярное выражение")
		CheckBoxGadget(#chFindItem, 5, 75, 155, 25, Lng(45))
		If flgFinditem
			SetGadgetState(#chFindItem, #PB_Checkbox_Checked)
		EndIf
		CheckBoxGadget(#chFindClass, 5, 100, 155, 25, Lng(46))
		If flgFindClass
			SetGadgetState(#chFindClass, #PB_Checkbox_Checked)
		EndIf
		CheckBoxGadget(#chFindCode, 5, 125, 155, 25, Lng(47))
		If flgFindCode
					...
					Select EventGadget()
						Case #btnCount
							...
							If Not Asc(SearchText$)
								SetGadgetText(#StatusBar, Lng(48))
								Continue
							EndIf
							...
							If Not (flgFindCode + flgFindClass + flgFinditem)
								SetGadgetText(#StatusBar, Lng(49))
...
; 								If Asc(MenuEntryList()\Name) = Asc(SepCode$)
								...
								EndIf
							Next
							SetGadgetText(#StatusBar, Lng(50) + Str(i))
...
; 								If Asc(MenuEntryList()\Name) = Asc(SepCode$)
								...
								EndIf
							Next
							SetGadgetText(#StatusBar, Lng(51))
					EndSelect
				Case #PB_Event_CloseWindow
					Break
			EndSelect
